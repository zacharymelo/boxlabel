...
class modBoxlabel extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->tabs = array();
		$this->tabs[] = array('data' => 'mo@mrp:+boxlabel:BoxLabels,BoxLabel,/boxlabel/class/boxlabel.class.php,countForMo:boxlabel@boxlabel:$user->hasRight(\'boxlabel\', \'boxlabel\', \'read\'):/boxlabel/mo_boxlabel.php?fk_mo=__ID__');
